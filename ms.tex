...
The stream's proximity to the Galactic center suggests that the bar should have a significant influence on its dynamical history: The triaxiality and time-dependence of the bar may generate chaotic orbits in the vicinity of the stream that can greatly affect its morphology. 
...
These results motivate efforts to obtain deep photometry and spectroscopy of the region surrounding the stream to detect this predicted low-surface-brightness tidal debris.
The existence of or lack of these features would provide an interesting constraint on the properties of the Milky Way bar and would help distinguish between formation scenarios for the stream.
