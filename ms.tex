...
- increased positional dispersion may be just projection

- if orbit is correct, at current time we're looking roughly onto the instantaneous orbital plane. if thats the case, the straightness of the stream is interesting because that means the thing must have totally disrupted (no sign of L pts.)

- only run on mean streams, show all -- discuss that morphology is very sensitive to the bar properties

- some of the models have large dispersion, some have etc...
